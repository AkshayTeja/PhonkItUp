          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex md:hidden items-center gap-2">
              ...
              <Sheet>
                ...
                <SheetContent side="right" className="bg-[#0f0f0f] border-gray-800 p-0">
                  <div className="flex flex-col h-full">
                    ...
                    <div className="flex-1 py-4">
                      <nav className="space-y-2 px-2">
                        <Link href="/home" className="flex items-center p-3 rounded-lg hover:bg-gray-800">
                          <Home className="mr-3 h-5 w-5" />
                          Home
                        </Link>
                        <Link href="/trending" className="flex items-center p-3 rounded-lg hover:bg-gray-800">
                          <TrendingUp className="mr-3 h-5 w-5" />
                          What&apos;s Hot?
                        </Link>
                        <Link href="/profile" className="flex items-center p-3 rounded-lg hover:bg-gray-800">
      ...
      {isSearchOpen && (
        <div className="md:hidden bg-[#0f0f0f] border-b border-gray-800 p-3 sticky top-16 z-40">
          <div className="relative">
            ...
            <Input placeholder="Search tracks, artists..." className="pl-9 bg-gray-900 border-gray-700" autoFocus />
            <Button
              variant="ghost"
              size="icon"
