...
import { Settings, Music, Clock, Heart, AirplayIcon as PlaylistAdd, Edit, Share2 } from "lucide-react"
...
const userPlaylists = [
  { id: 1, title: "My Phonk Favorites", tracks: 24, cover: "/placeholder.svg?height=120&width=120" },
  { id: 2, title: "Drift Phonk", tracks: 18, cover: "/placeholder.svg?height=120&width=120" },
  { id: 3, title: "Workout Phonk", tracks: 15, cover: "/placeholder.svg?height=120&width=120" },
  { id: 4, title: "Chill Phonk", tracks: 12, cover: "/placeholder.svg?height=120&width=120" },
]
...
const recentlyPlayed = [
  ...
  { id: 2, title: "Tokyo Phonk", artist: "Dvrst", playedAt: "Yesterday", cover: "/placeholder.svg?height=80&width=80" },
  {
    id: 3,
  ...
  { id: 4, title: "Close Eyes", artist: "DVRST", playedAt: "2 days ago", cover: "/placeholder.svg?height=80&width=80" },
  { id: 5, title: "Sahara", artist: "Hensonn", playedAt: "3 days ago", cover: "/placeholder.svg?height=80&width=80" },
]
        ...
        <div className="relative mb-10">
          ...
          <div className="absolute -bottom-16 left-8 flex items-end">
            ...
            <div className="ml-4 mb-4">
              ...
              <p className="text-gray-400">@johndoe • 42 Playlists • 128 Followers</p>
            </div>
          </div>
        ...
        <div className="mt-20">
          <Tabs defaultValue="playlists" className="mb-10">
            <TabsList className="bg-gray-900 border border-gray-800">
              ...
              <TabsTrigger value="liked" className="data-[state=active]:bg-purple-600">
                    ...
                    <div className="bg-[#0f0f0f] rounded-xl overflow-hidden transition-transform group-hover:translate-y-[-5px]">
                      <div className="relative aspect-square">
                        ...
                        <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
                          <Button className="bg-purple-600 hover:bg-purple-700 h-12 w-12 rounded-full p-0">
            ...
            <TabsContent value="liked" className="mt-6">
              ...
              <div className="bg-[#0f0f0f] rounded-xl border border-gray-800 p-8 text-center">
                ...
                <Link href="/home">
                  <Button className="bg-purple-600 hover:bg-purple-700">Discover Music</Button>
                </Link>
              </div>
            </TabsContent>
          </Tabs>
