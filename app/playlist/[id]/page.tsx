...
interface PlaylistTrack {
  ...
  track_url: string;
  duration: string;
  playlist_track_id: string; // ID of the playlist_tracks entry
}
    ...
    const fetchPlaylist = async () => {
      try {
        ...
        setPlaylist({
          ...
          tracks: playlistData.playlist_tracks.map((pt: any) => ({
                    ...
                    <Button
                      ...
                      onClick={() => {
                        if (playlist.tracks.length > 0) {
                          playTrack(playlist.tracks[0]); // Play first track
                        }
                      }}
                    >
                ...
                <div className="space-y-4">
                  {playlist.tracks.map((track) => (
                    ...
                    >
                      ...
                      <Button
                        className="bg-[#ff6700] hover:bg-[#cc5300] h-10 w-10 rounded-full p-0 opacity-0 group-hover:opacity-100"
